					...
					<tbody>
						<c:choose>
							<c:when test="${musicList eq null || empty musicList }">
								<tr>
									<td colspan="3" align="center">등록된 노래가 없습니다.</td>
								</tr>
							</c:when>
							<c:otherwise>
								...
								<table>
									<tr>
										...
										<td><span class="spanTitle">${music.name }</span><a
											class="btn btn-xs btn-default" href="detail.do?musicId=${music.id }"><b>i</b></a></td>
									</tr>
									<tr>
							...
							<td><a class="btn btn-xs btn-info btnPlay"
								href="addFavorite.do?musicId=${music.id }">담기</a></td>
						</tr>
						</c:forEach>
						</c:otherwise>
						</c:choose>
